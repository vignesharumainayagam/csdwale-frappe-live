...
from frappe.website.csdroute import CustomURL
import io
...
def resolve_route(path):
	...
	customurl = CustomURL()
	customurl.setCustomUrl(path)
	if (customurl.IsCustom):

		p_type = customurl.getCustomUrl()
		return get_custom_page_info(p_type, path, 'cartrade', path, None, app_path=None)
...
def get_custom_page_info(p_type, path, app, url, start, basepath=None, app_path=None, fname=None):
	...
	# get the source
	page_info.template='templates/pages/cars/index.md'
	page_info.page_or_generator='Page',
	page_info.basepath=''
	page_info.route=path 
	page_info.page_name='cartrade'
	page_info.basename='' 
	page_info.name=p_type

	if p_type == "custompage":
		page_info.controller = 'cartrade.templates.pages.custompage'
		page_info.template = 'templates/pages/custompage.html'
		page_info.controller_path     

	if p_type == "homepage":
		page_info.controller = 'cartrade.templates.pages.homepage'
		page_info.template = 'templates/pages/homepage.html'
		page_info.controller_path ='/home/tridots/carwale/apps/cartrade/cartrade/templates/pages/homepage.py',

	if p_type == "cathomepage":
		page_info.controller = 'cartrade.templates.pages.categoryhome'
		page_info.template = 'templates/pages/categoryhome.html'
		page_info.controller_path ='/home/tridots/carwale/apps/cartrade/cartrade/templates/pages/categoryhome.py',

	if p_type == "listpage":
		page_info.controller = 'cartrade.templates.pages.listpage'
		page_info.template = 'templates/pages/listpage.html'
		page_info.controller_path ='/home/tridots/carwale/apps/cartrade/cartrade/templates/pages/listpage.py',

	if p_type == "detailpage":
		page_info.controller = 'cartrade.templates.pages.details'
		page_info.template = 'templates/pages/details.html'
		page_info.controller_path ='/home/tridots/carwale/apps/cartrade/cartrade/templates/pages/details.py',

	if p_type == "varientdetailpage":
		page_info.controller = 'cartrade.templates.pages.details_variants'
		page_info.template = 'templates/pages/details_variants.html'
		page_info.controller_path ='/home/tridots/carwale/apps/cartrade/cartrade/templates/pages/details_variants.py',

	if p_type == "view_images":
		page_info.controller = 'cartrade.templates.pages.view_images'
		page_info.template = 'templates/pages/view_images.html'
		page_info.controller_path ='/home/tridots/carwale/apps/cartrade/cartrade/templates/pages/view_images.py',

	if p_type == "dealers_list":
		page_info.controller = 'cartrade.templates.pages.dealers_list'
		page_info.template = 'templates/pages/dealers_list.html'
		page_info.controller_path ='/home/tridots/carwale/apps/cartrade/cartrade/templates/pages/dealers_list.py',

	if p_type == "dealers":
		page_info.controller = 'cartrade.templates.pages.dealers'
		page_info.template = 'templates/pages/dealers.html'
		page_info.controller_path ='/home/tridots/carwale/apps/cartrade/cartrade/templates/pages/dealers.py',

	if p_type == "blog_detail":
		page_info.controller = 'cartrade.templates.pages.blog_detail'
		page_info.template = 'templates/pages/blog_detail.html'
		page_info.controller_path ='/home/tridots/carwale/apps/cartrade/cartrade/templates/pages/blog_detail.py',
	
	if p_type == "dealercity":
		page_info.controller = 'cartrade.templates.pages.dealercity'
		page_info.template = 'templates/pages/dealercity.html'
		page_info.controller_path ='/home/tridots/carwale/apps/cartrade/cartrade/templates/pages/dealercity.py',

	if p_type == "dealercategory":
		page_info.controller = 'cartrade.templates.pages.dealercategory'
		page_info.template = 'templates/pages/dealercategory.html'
		page_info.controller_path ='/home/tridots/carwale/apps/cartrade/cartrade/templates/pages/dealercategory.py',

	if p_type == "dealerbrand":
		page_info.controller = 'cartrade.templates.pages.dealerbrand'
		page_info.template = 'templates/pages/dealerbrand.html'
		page_info.controller_path ='/home/tridots/carwale/apps/cartrade/cartrade/templates/pages/dealerbrand.py',
